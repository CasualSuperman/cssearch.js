(function(){
	...
	var properties = [
		...
		["::before"],
		["::after"],
		[/^:nth-child\(\s*([oO][dD]{2}|[eE][vV][eE][nN]|[-+]?\d+|[-+]?\d*[nN](\s*[-+]\s*\d+)?)\s*\)/],
		[/^:nth-last-type\(\s*([oO][dD]{2}|[eE][vV][eE][nN]|[-+]?\d+|[-+]?\d*[nN](\s*[-+]\s*\d+)?)\s*\)/],
		[/^:nth-of-type\(\s*([oO][dD]{2}|[eE][vV][eE][nN]|[-+]?\d+|[-+]?\d*[nN](\s*[-+]\s*\d+)?)\s*\)/],
		[/^:nth-last-of-type\(\s*([oO][dD]{2}|[eE][vV][eE][nN]|[-+]?\d+|[-+]?\d*[nN](\s*[-+]\s*\d+)?)\s*\)/],
		[/^\[\w+\]/],
		[/^\[\w+="((?:[^"]+|(?:\\)")*)"\]/],
		[/^\[\w+~="((?:[^"]+|(?:\\)")*)"\]/],
		[/^\[\w+\^="((?:[^"]+|(?:\\)")*)"\]/],
